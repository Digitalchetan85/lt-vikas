      ...
      <div id="desktop-fix" className="position-realtive d-none d-md-block">
        <div className="container">
          <div className="d-flex=column justify-content-end mb-2 position-fixed custom">
            ...
            <div className="my-5">
              <a
                href="https://wa.me/919738269105?text='Hi! I'm Interested In L&T RAINTREE BOULEVARD Project, Bangalore. Please Share Details.'"
                target="_blank"
                className="bg-primary p-3 rounded-circle m-2"
              >
                <i
      ...
      <div id="gotop" className="">
        <div className="container">
          <div className="my-5">
            ...
            >
              <i
                className="fas fa-arrow-up text-white fs-5"
                aria-hidden="true"
              ></i>
            </a>
          </div>
