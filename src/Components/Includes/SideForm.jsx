...
const SideForm = () => {
  const [cssClass, setcssClass] = useState("stickyForm rounded");
  const [btnName, setBtnName] = useState("Get Expert Call");
  const FormClick = (e) => {
    e.preventDefault();
    ...
    <div id="side-contact-form" className="">
      <Container>
        <div className={cssClass} id="" autoComplete="off">
          <button className="btn btn-hello text-uppercase" onClick={FormClick}>
            {btnName}
          </button>
